...
//WebUI.delay(10)
//
//WebUI.click(findTestObject('UserProfile/Logout/Page_littlefish - Web-portal/button_Sign In'))
...
WebUI.click(findTestObject('UserProfile/Logout/Page_littlefish - Web-portal/svg_littlefish_iconify iconify--mdi'))

WebUI.delay(5)

WebUI.click(findTestObject('UserProfile/Logout/Page_littlefish - Web-portal/li_Logout'))
