...
WebUI.setText(findTestObject('SignIn/N1/Page_littlefish - Web-portal/input_Email_r0'), 'd')

WebUI.delay(2)

WebUI.setText(findTestObject('SignIn/Page_littlefish - Web-portal/input_Email_r0'), 'mdecarvalho@littlefishapps.com')
...
WebUI.click(findTestObject('SignIn/N1/Page_littlefish - Web-portal/button_Sign In'))
