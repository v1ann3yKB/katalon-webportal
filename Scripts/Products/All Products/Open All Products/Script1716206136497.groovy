...
//WebUI.delay(5)
//
//WebUI.click(findTestObject('Products/AllProducts/Page_littlefish - Web-portal/button_Sign In'))
//
//WebUI.openBrowser('')
//
//WebUI.navigateToUrl('https://portal.littlefish.mobi/')
...
WebUI.click(findTestObject('Products/AllProducts/Page_littlefish - Web-portal/div_Products'))

WebUI.delay(3)

WebUI.click(findTestObject('Products/AllProducts/Page_littlefish - Web-portal/a_All Products'))
